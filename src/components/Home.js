...
export default function Home() {
    ...
    return (
        <Grid container direction='row' alignItems='flex-start' justifyContent='center' style={{ minHeight:'100vh', backgroundColor:'black', backgroundImage: 'linear-gradient(rgba(0, 0, 0, .5), rgba(0, 0, 0, .5)), url("https://res.cloudinary.com/deuft4auk/image/upload/v1661790409/Tesla/0x0-ModelY_12_hq32tl.jpg")', backgroundSize: 'cover',backgroundPosition: 'center'
        }} >
