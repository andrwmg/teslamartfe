...
export default function ShowGallery({ images, defaultMain }) {
    ...
    return (
        <Paper elevation={3} style={{borderRadius:'10px',overflow:'hidden',marginTop: '0px', background: '#333333', height: '100%', maxHeight:{xs: '30%', md: '100%'}, width:'100%'}}>
            <Grid container item direction='column' justifyContent='center' sx={{ background: 'black', height: 'calc(100% - 108px)', overflow: 'hidden', display: 'flex', marginBottom: '.5rem' }}>
